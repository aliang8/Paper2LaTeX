...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("../images/alphabet_custom.jpg")            # read in training numbers image
    #imgTrainingNumbers = cv2.imread("../images/alphabet.png")            # read in training numbers image
    ...
    for npaContour in npaContours:                          # for each contour
		...
		print 'No because it was ', intChar
            # end if
        # end if
    # end for
